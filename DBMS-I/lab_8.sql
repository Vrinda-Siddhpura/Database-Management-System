...
SELECT REGION, COUNT(SALES_AMOUNT) AS TOTAL_SOLD
FROM SALES_DATA
GROUP BY REGION
...
SELECT YEAR, REGION, COUNT(SALES_AMOUNT) AS TOTAL_SALES
FROM SALES_DATA
...
SELECT TOP 1 REGION, YEAR, SUM(SALES_AMOUNT) AS TOTAL_SALES
FROM SALES_DATA
GROUP BY REGION, YEAR
ORDER BY SUM(SALES_AMOUNT)
...
SELECT REGION, YEAR, COUNT(SALES_AMOUNT) AS TOTAL_SALES
FROM SALES_DATA
GROUP BY REGION, YEAR
...
SELECT REGION, PRODUCT, COUNT(PRODUCT) AS DUPLICATE_PRODUCT
FROM SALES_DATA
...
SELECT YEAR, PRODUCT, COUNT(PRODUCT) AS DUPLICATE_PRODUCT
FROM SALES_DATA
GROUP BY YEAR, PRODUCT
HAVING COUNT(PRODUCT)>1